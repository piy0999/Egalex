    ...
    var title = (
      <span>
        <a href="http://startreact.com/" title="Start React" rel="home">
          <img
            src="http://startreact.com/wp-content/themes/dazzling-child/images/logo.png"
            alt="Start React"
            title="Start React"
            height="35px"
          />&nbsp;SB Admin React - StartReact.com
        </a>
      </span>
    );
          ...
          <div className="row">
            <div className="col-sm-3 col-md-2 sidebar">
              ...
              <ul className="nav nav-sidebar">
                ...
                <li>
                  <a href="http://startangular.com/product/ani-theme/">
                    My case 1
                  </a>
                </li>
                <li>
                  <a href="http://www.strapui.com/ani-reactjs-theme">
                    My case 2
                  </a>
                </li>
                <li>
                  <a href="http://www.strapui.com/ani-angularjs-theme">
                    My case 3
                  </a>
                </li>
                <li>
                  <a href="http://www.strapui.com/themes/ani-laravel-theme/">
                    My case 4
                  </a>
                </li>
              </ul>
