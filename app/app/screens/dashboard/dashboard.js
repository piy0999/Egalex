...
export class Dashboard extends React.Component {
  ...
  render() {
    ...
    console.log(this.props.newBody);
    return (
      <ScrollView style={styles.screen}>
        <RkText style={{ marginTop: 10, alignSelf: 'center' }}>
          Thank you, We will try our best to connect you with a lawyer.
        </RkText>
      </ScrollView>
    );
  }
